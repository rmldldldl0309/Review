/*
    디스트럭처링 :
    - 구조화된 배열 또는 객체를 비구조화, 구조화 파괴하여 개별변수로 할당하는 것
    - 배열 또는 객체에서 필요한 데이터만 추출하여 사용할 수 있도록 해줌
*/
const king = {
    name:'이성계',
    tombName:'태조',
...
// 만약 배열 디스트럭처링에 배열의 길이르르 초과한 변수를 선언하면, 초과한 범위에 대하여 해당 변수는 undefined됨
