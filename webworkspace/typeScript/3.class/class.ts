...
class Sample3 {
    constructor(
        ...
        protected protectedField: string,
        public publicField: string,
        // 샘플 3의 속성 X / 제어자가 존재하지 않아 일반적인 매개변수로 인식, 제어자가 있어야 멤버변수로서 인식
...
const sample3Instance = new Sample3('publicField', 'privateField', 'protectedField', 'localVariable');
...
/*
    readonly :
    - readonly가 선언된 클래스속성은 선언 시 또는 생성자 내부에서만 값을 할당 할 수 있다
...
const sample4Instance = new Sample4('퍼블릭 읽기전용 필드2', '퍼블릭 읽기 전용 필드3')
